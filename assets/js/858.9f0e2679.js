...
"use strict";(self.webpackChunklearn_data=self.webpackChunklearn_data||[]).push([[858],{580:(t,e,s)=>{s.d(e,{T:()=>a});var n=s(4703),i=s(2993);class o extends i.D{}o.directiveName="unsafeSVG",o.resultType=2;const a=(0,n.u$)(o)},1822:(t,e,s)=>{s.d(e,{J:()=>i});var n=s(4245);const i=t=>null!=t?t:n.s6},2537:(t,e,s)=>{s.d(e,{W:()=>i});var n=s(4245);class i extends HTMLElement{rootPart=null;connectedCallback(){this.rootPart=(0,n.XX)(this.render(),this,{renderBefore:this.firstChild}),this.rootPart.setConnected(!0)}disconnectedCallback(){this.rootPart?.setConnected(!1),this.rootPart=null,(0,n.XX)(null,this)}}},2993:(t,e,s)=>{s.d(e,{D:()=>o,_:()=>a});var n=s(4245),i=s(4703);class o extends i.WL{constructor(t){if(super(t),this.et=n.s6,t.type!==i.OA.CHILD)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(t){if(t===n.s6||null==t)return this.ft=void 0,this.et=t;if(t===n.c0)return t;if("string"!=typeof t)throw Error(this.constructor.directiveName+"() called with a non-string value");if(t===this.et)return this.ft;this.et=t;const e=[t];return e.raw=e,this.ft={_$litType$:this.constructor.resultType,strings:e,values:[]}}}o.directiveName="unsafeHTML",o.resultType=1;const a=(0,i.u$)(o)},4245:(t,e,s)=>{var n;s.d(e,{XX:()=>K,c0:()=>C,ge:()=>G,qy:()=>k,s6:()=>q});const i=window,o=i.trustedTypes,a=o?o.createPolicy("lit-html",{createHTML:t=>t}):void 0,l="$lit$",r=`lit$${(Math.random()+"").slice(9)}$`,d="?"+r,c=`<${d}>`,u=document,p=()=>u.createComment(""),m=t=>null===t||"object"!=typeof t&&"function"!=typeof t,h=Array.isArray,v=t=>h(t)||"function"==typeof(null==t?void 0:t[Symbol.iterator]),$="[ \t\n\f\r]",g=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,b=/-->/g,y=/>/g,f=RegExp(`>|${$}(?:([^\\s"'>=/]+)(${$}*=${$}*(?:[^ \t\n\f\r"'\`<>=]|("|')|))|$)`,"g"),x=/'/g,A=/"/g,_=/^(?:script|style|textarea|title)$/i,w=t=>(e,...s)=>({_$litType$:t,strings:e,values:s}),k=w(1),C=(w(2),Symbol.for("lit-noChange")),q=Symbol.for("lit-nothing"),S=new WeakMap,Z=u.createTreeWalker(u,129,null,!1);function T(t,e){if(!Array.isArray(t)||!t.hasOwnProperty("raw"))throw Error("invalid template strings array");return void 0!==a?a.createHTML(e):e}const M=(t,e)=>{const s=t.length-1,n=[];let i,o=2===e?"<svg>":"",a=g;for(let e=0;e<s;e++){const s=t[e];let d,u,p=-1,m=0;for(;m<s.length&&(a.lastIndex=m,u=a.exec(s),null!==u);)m=a.lastIndex,a===g?"!--"===u[1]?a=b:void 0!==u[1]?a=y:void 0!==u[2]?(_.test(u[2])&&(i=RegExp("</"+u[2],"g")),a=f):void 0!==u[3]&&(a=f):a===f?">"===u[0]?(a=null!=i?i:g,p=-1):void 0===u[1]?p=-2:(p=a.lastIndex-u[2].length,d=u[1],a=void 0===u[3]?f:'"'===u[3]?A:x):a===A||a===x?a=f:a===b||a===y?a=g:(a=f,i=void 0);const h=a===f&&t[e+1].startsWith("/>")?" ":"";o+=a===g?s+c:p>=0?(n.push(d),s.slice(0,p)+l+s.slice(p)+r+h):s+r+(-2===p?(n.push(void 0),e):h)}return[T(t,o+(t[s]||"<?>")+(2===e?"</svg>":"")),n]};class I{constructor({strings:t,_$litType$:e},s){let n;this.parts=[];let i=0,a=0;const c=t.length-1,u=this.parts,[m,h]=M(t,e);if(this.el=I.createElement(m,s),Z.currentNode=this.el.content,2===e){const t=this.el.content,e=t.firstChild;e.remove(),t.append(...e.childNodes)}for(;null!==(n=Z.nextNode())&&u.length<c;){if(1===n.nodeType){if(n.hasAttributes()){const t=[];for(const e of n.getAttributeNames())if(e.endsWith(l)||e.startsWith(r)){const s=h[a++];if(t.push(e),void 0!==s){const t=n.getAttribute(s.toLowerCase()+l).split(r),e=/([.?@])?(.*)/.exec(s);u.push({type:1,index:i,name:e[2],strings:t,ctor:"."===e[1]?N:"?"===e[1]?V:"@"===e[1]?H:P})}else u.push({type:6,index:i})}for(const e of t)n.removeAttribute(e)}if(_.test(n.tagName)){const t=n.textContent.split(r),e=t.length-1;if(e>0){n.textContent=o?o.emptyScript:"";for(let s=0;s<e;s++)n.append(t[s],p()),Z.nextNode(),u.push({type:2,index:++i});n.append(t[e],p())}}}else if(8===n.nodeType)if(n.data===d)u.push({type:2,index:i});else{let t=-1;for(;-1!==(t=n.data.indexOf(r,t+1));)u.push({type:7,index:i}),t+=r.length-1}i++}}static createElement(t,e){const s=u.createElement("template");return s.innerHTML=t,s}}function W(t,e,s=t,n){var i,o,a,l;if(e===C)return e;let r=void 0!==n?null===(i=s._$Co)||void 0===i?void 0:i[n]:s._$Cl;const d=m(e)?void 0:e._$litDirective$;return(null==r?void 0:r.constructor)!==d&&(null===(o=null==r?void 0:r._$AO)||void 0===o||o.call(r,!1),void 0===d?r=void 0:(r=new d(t),r._$AT(t,s,n)),void 0!==n?(null!==(a=(l=s)._$Co)&&void 0!==a?a:l._$Co=[])[n]=r:s._$Cl=r),void 0!==r&&(e=W(t,r._$AS(t,e.values),r,n)),e}class O{constructor(t,e){this._$AV=[],this._$AN=void 0,this._$AD=t,this._$AM=e}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(t){var e;const{el:{content:s},parts:n}=this._$AD,i=(null!==(e=null==t?void 0:t.creationScope)&&void 0!==e?e:u).importNode(s,!0);Z.currentNode=i;let o=Z.nextNode(),a=0,l=0,r=n[0];for(;void 0!==r;){if(a===r.index){let e;2===r.type?e=new E(o,o.nextSibling,this,t):1===r.type?e=new r.ctor(o,r.name,r.strings,this,t):6===r.type&&(e=new L(o,this,t)),this._$AV.push(e),r=n[++l]}a!==(null==r?void 0:r.index)&&(o=Z.nextNode(),a++)}return Z.currentNode=u,i}v(t){let e=0;for(const s of this._$AV)void 0!==s&&(void 0!==s.strings?(s._$AI(t,s,e),e+=s.strings.length-2):s._$AI(t[e])),e++}}class E{constructor(t,e,s,n){var i;this.type=2,this._$AH=q,this._$AN=void 0,this._$AA=t,this._$AB=e,this._$AM=s,this.options=n,this._$Cp=null===(i=null==n?void 0:n.isConnected)||void 0===i||i}get _$AU(){var t,e;return null!==(e=null===(t=this._$AM)||void 0===t?void 0:t._$AU)&&void 0!==e?e:this._$Cp}get parentNode(){let t=this._$AA.parentNode;const e=this._$AM;return void 0!==e&&11===(null==t?void 0:t.nodeType)&&(t=e.parentNode),t}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(t,e=this){t=W(this,t,e),m(t)?t===q||null==t||""===t?(this._$AH!==q&&this._$AR(),this._$AH=q):t!==this._$AH&&t!==C&&this._(t):void 0!==t._$litType$?this.g(t):void 0!==t.nodeType?this.$(t):v(t)?this.T(t):this._(t)}k(t){return this._$AA.parentNode.insertBefore(t,this._$AB)}$(t){this._$AH!==t&&(this._$AR(),this._$AH=this.k(t))}_(t){this._$AH!==q&&m(this._$AH)?this._$AA.nextSibling.data=t:this.$(u.createTextNode(t)),this._$AH=t}g(t){var e;const{values:s,_$litType$:n}=t,i="number"==typeof n?this._$AC(t):(void 0===n.el&&(n.el=I.createElement(T(n.h,n.h[0]),this.options)),n);if((null===(e=this._$AH)||void 0===e?void 0:e._$AD)===i)this._$AH.v(s);else{const t=new O(i,this),e=t.u(this.options);t.v(s),this.$(e),this._$AH=t}}_$AC(t){let e=S.get(t.strings);return void 0===e&&S.set(t.strings,e=new I(t)),e}T(t){h(this._$AH)||(this._$AH=[],this._$AR());const e=this._$AH;let s,n=0;for(const i of t)n===e.length?e.push(s=new E(this.k(p()),this.k(p()),this,this.options)):s=e[n],s._$AI(i),n++;n<e.length&&(this._$AR(s&&s._$AB.nextSibling,n),e.length=n)}_$AR(t=this._$AA.nextSibling,e){var s;for(null===(s=this._$AP)||void 0===s||s.call(this,!1,!0,e);t&&t!==this._$AB;){const e=t.nextSibling;t.remove(),t=e}}setConnected(t){var e;void 0===this._$AM&&(this._$Cp=t,null===(e=this._$AP)||void 0===e||e.call(this,t))}}class P{constructor(t,e,s,n,i){this.type=1,this._$AH=q,this._$AN=void 0,this.element=t,this.name=e,this._$AM=n,this.options=i,s.length>2||""!==s[0]||""!==s[1]?(this._$AH=Array(s.length-1).fill(new String),this.strings=s):this._$AH=q}get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}_$AI(t,e=this,s,n){const i=this.strings;let o=!1;if(void 0===i)t=W(this,t,e,0),o=!m(t)||t!==this._$AH&&t!==C,o&&(this._$AH=t);else{const n=t;let a,l;for(t=i[0],a=0;a<i.length-1;a++)l=W(this,n[s+a],e,a),l===C&&(l=this._$AH[a]),o||(o=!m(l)||l!==this._$AH[a]),l===q?t=q:t!==q&&(t+=(null!=l?l:"")+i[a+1]),this._$AH[a]=l}o&&!n&&this.j(t)}j(t){t===q?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,null!=t?t:"")}}class N extends P{constructor(){super(...arguments),this.type=3}j(t){this.element[this.name]=t===q?void 0:t}}const B=o?o.emptyScript:"";class V extends P{constructor(){super(...arguments),this.type=4}j(t){t&&t!==q?this.element.setAttribute(this.name,B):this.element.removeAttribute(this.name)}}class H extends P{constructor(t,e,s,n,i){super(t,e,s,n,i),this.type=5}_$AI(t,e=this){var s;if((t=null!==(s=W(this,t,e,0))&&void 0!==s?s:q)===C)return;const n=this._$AH,i=t===q&&n!==q||t.capture!==n.capture||t.once!==n.once||t.passive!==n.passive,o=t!==q&&(n===q||i);i&&this.element.removeEventListener(this.name,this,n),o&&this.element.addEventListener(this.name,this,t),this._$AH=t}handleEvent(t){var e,s;"function"==typeof this._$AH?this._$AH.call(null!==(s=null===(e=this.options)||void 0===e?void 0:e.host)&&void 0!==s?s:this.element,t):this._$AH.handleEvent(t)}}class L{constructor(t,e,s){this.element=t,this.type=6,this._$AN=void 0,this._$AM=e,this.options=s}get _$AU(){return this._$AM._$AU}_$AI(t){W(this,t)}}const G={O:l,P:r,A:d,C:1,M,L:O,R:v,D:W,I:E,V:P,H:V,N:H,U:N,F:L},R=i.litHtmlPolyfillSupport;null==R||R(I,E),(null!==(n=i.litHtmlVersions)&&void 0!==n?n:i.litHtmlVersions=[]).push("2.8.0");const K=(t,e,s)=>{var n,i;const o=null!==(n=null==s?void 0:s.renderBefore)&&void 0!==n?n:e;let a=o._$litPart$;if(void 0===a){const t=null!==(i=null==s?void 0:s.renderBefore)&&void 0!==i?i:null;o._$litPart$=a=new E(e.insertBefore(p(),t),t,void 0,null!=s?s:{})}return a._$AI(t),a}},4703:(t,e,s)=>{s.d(e,{OA:()=>n,WL:()=>o,u$:()=>i});const n={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},i=t=>(...e)=>({_$litDirective$:t,values:e});class o{constructor(t){}get _$AU(){return this._$AM._$AU}_$AT(t,e,s){this._$Ct=t,this._$AM=e,this._$Ci=s}_$AS(t,e){return this.update(t,e)}update(t,e){return this.render(...e)}}},6214:(t,e,s)=>{s.d(e,{Kq:()=>u,OA:()=>i.OA,u$:()=>i.u$});var n=s(7727),i=s(4703);const o=(t,e)=>{var s,n;const i=t._$AN;if(void 0===i)return!1;for(const t of i)null===(n=(s=t)._$AO)||void 0===n||n.call(s,e,!1),o(t,e);return!0},a=t=>{let e,s;do{if(void 0===(e=t._$AM))break;s=e._$AN,s.delete(t),t=e}while(0===(null==s?void 0:s.size))},l=t=>{for(let e;e=t._$AM;t=e){let s=e._$AN;if(void 0===s)e._$AN=s=new Set;else if(s.has(t))break;s.add(t),c(e)}};function r(t){void 0!==this._$AN?(a(this),this._$AM=t,l(this)):this._$AM=t}function d(t,e=!1,s=0){const n=this._$AH,i=this._$AN;if(void 0!==i&&0!==i.size)if(e)if(Array.isArray(n))for(let t=s;t<n.length;t++)o(n[t],!1),a(n[t]);else null!=n&&(o(n,!1),a(n));else o(this,t)}const c=t=>{var e,s,n,o;t.type==i.OA.CHILD&&(null!==(e=(n=t)._$AP)&&void 0!==e||(n._$AP=d),null!==(s=(o=t)._$AQ)&&void 0!==s||(o._$AQ=r))};class u extends i.WL{constructor(){super(...arguments),this._$AN=void 0}_$AT(t,e,s){super._$AT(t,e,s),l(this),this.isConnected=t._$AU}_$AO(t,e=!0){var s,n;t!==this.isConnected&&(this.isConnected=t,t?null===(s=this.reconnected)||void 0===s||s.call(this):null===(n=this.disconnected)||void 0===n||n.call(this)),e&&(o(this,t),a(this))}setValue(t){if((0,n.Rt)(this._$Ct))this._$Ct._$AI(t,this);else{const e=[...this._$Ct._$AH];e[this._$Ci]=t,this._$Ct._$AI(e,this,0)}}disconnected(){}reconnected(){}}},7243:(t,e,s)=>{function n(t,e){return[...t].sort(e?o:i)}function i(t,e){return t.height===e.height?(t.bitrate??0)-(e.bitrate??0):t.height-e.height}function o(t,e){return e.height===t.height?(e.bitrate??0)-(t.bitrate??0):e.height-t.height}s.d(e,{F:()=>n})},7727:(t,e,s)=>{s.d(e,{Rt:()=>o,mY:()=>l});var n=s(4245);const{I:i}=n.ge,o=t=>void 0===t.strings,a={},l=(t,e=a)=>t._$AH=e},7858:(t,e,s)=>{var n=s(4487),i=s(9469),o=s(2106),a=s(4245),l=s(8145),r=s(2037),d=s(7243),c=s(1822),u=s(6214),p=s(4703);const m=new WeakMap,h=(0,p.u$)(class extends u.Kq{render(t){return a.s6}update(t,[e]){var s;const n=e!==this.G;return n&&void 0!==this.G&&this.ot(void 0),(n||this.rt!==this.lt)&&(this.G=e,this.dt=null===(s=t.options)||void 0===s?void 0:s.host,this.ot(this.lt=t.element)),a.s6}ot(t){var e;if("function"==typeof this.G){const s=null!==(e=this.dt)&&void 0!==e?e:globalThis;let n=m.get(s);void 0===n&&(n=new WeakMap,m.set(s,n)),void 0!==n.get(this.G)&&this.G.call(this.dt,void 0),n.set(this.G,t),void 0!==t&&this.G.call(this.dt,t)}else this.G.value=t}get rt(){var t,e,s;return"function"==typeof this.G?null===(e=m.get(null!==(t=this.dt)&&void 0!==t?t:globalThis))||void 0===e?void 0:e.get(this.G):null===(s=this.G)||void 0===s?void 0:s.value}disconnected(){this.rt===this.lt&&this.ot(void 0)}reconnected(){this.ot(this.lt)}});var v=s(3362);const $=(0,n.q6)();function g(){return(0,n.NT)($)}const b={colorScheme:"system",download:null,customIcons:!1,disableTimeSlider:!1,menuContainer:null,menuGroup:"bottom",noAudioGain:!1,noGestures:!1,noKeyboardAnimations:!1,noModal:!1,noScrubGesture:!1,playbackRates:{min:0,max:2,step:.25},audioGains:{min:0,max:300,step:25},seekStep:10,sliderChaptersMinWidth:325,hideQualityBitrate:!1,smallWhen:!1,thumbnails:null,translations:null,when:!1};class y extends n.uA{static props=b;#t;#e=(0,n.EW)((()=>{const t=this.$props.when();return this.#s(t)}));#n=(0,n.EW)((()=>{const t=this.$props.smallWhen();return this.#s(t)}));get isMatch(){return this.#e()}get isSmallLayout(){return this.#n()}onSetup(){this.#t=(0,i.$c)(),this.setAttributes({"data-match":this.#e,"data-sm":()=>this.#n()?"":null,"data-lg":()=>this.#n()?null:"","data-size":()=>this.#n()?"sm":"lg","data-no-scrub-gesture":this.$props.noScrubGesture}),(0,n.Pp)($,{...this.$props,when:this.#e,smallWhen:this.#n,userPrefersAnnouncements:(0,n.O)(!0),userPrefersKeyboardAnimations:(0,n.O)(!0),menuPortal:(0,n.O)(null)})}onAttach(t){(0,o.GU)(t,this.$props.colorScheme)}#s(t){return"never"!==t&&((0,n.Lm)(t)?t:(0,n.EW)((()=>t(this.#t.player.state)))())}}const f=y.prototype;function x(t,e){(0,n.QZ)((()=>{const{player:s}=(0,i.$c)(),o=s.el;return o&&(0,n.Bq)(o,"data-layout",e()&&t),()=>o?.removeAttribute("data-layout")}))}function A(t,e){return t()?.[e]??e}function _(){return(0,l.xZ)((()=>{const{translations:t,userPrefersAnnouncements:e}=g();return e()?a.qy`<media-announcer .translations=${(0,l.xZ)(t)}></media-announcer>`:null}))}function w(t,e=""){return a.qy`<slot
  ...
  `}function T({tooltip:t,ref:e=n.lQ}){const{translations:s}=g(),i=C(s,"Mute"),o=C(s,"Unmute");return a.qy`
  ...
  `}function M({tooltip:t}){const{translations:e}=g(),s=C(e,"Closed-Captions On"),n=C(e,"Closed-Captions Off");return a.qy`
  ...
  `}function dt({label:t,checked:e,defaultChecked:s=!1,storageKey:i,onChange:r}){const{translations:d}=g(),c=i?localStorage.getItem(i):null,u=(0,n.O)(!!(c??s)),p=(0,n.O)(!1),m=(0,l.xZ)((0,o.Mc)(u)),h=C(d,t);function v(t){1!==t?.button&&(u.set((t=>!t)),i&&localStorage.setItem(i,u()?"1":""),r(u(),t),p.set(!1))}return i&&r((0,n.se)(u)),e&&(0,n.QZ)((()=>{u.set(e())})),a.qy`
    <div
  ...
  `}function At({placement:t,portal:e,tooltip:s}){return(0,l.xZ)((()=>{const{viewType:e}=(0,i.nV)(),{translations:o,menuPortal:r,noModal:c,menuGroup:u,smallWhen:p}=g(),m=(0,n.EW)((()=>c()?(0,n.oA)(t):p()?null:(0,n.oA)(t))),h=(0,n.EW)((()=>p()||"bottom"!==u()||"video"!==e()?0:26)),v=(0,n.O)(!1);!function(){const{player:t}=(0,i.$c)();j.add(t),(0,n.zp)((()=>j.delete(t))),z||((0,n.P1)((()=>{for(const e of(0,n.YD)(Q)){const s=Q[e],i=D[e],o=`--media-user-${(0,n.BW)(e)}`,a=`vds-player:${(0,n.BW)(e)}`;(0,n.QZ)((()=>{const n=s(),l=n===i,r=l?null:X(t,e,n);for(const t of j)t.el?.style.setProperty(o,r);l?localStorage.removeItem(a):localStorage.setItem(a,n)}))}}),null),z=!0)}();const $=a.qy`
      <media-menu-items
        class="vds-settings-menu-items vds-menu-items"
        placement=${(0,l.xZ)(m)}
        offset=${(0,l.xZ)(h)}
      >
        ${(0,l.xZ)((()=>v()?[(0,l.xZ)((()=>{const{translations:t}=g();return a.qy`
    ...
    `}))}function _t({orientation:t,tooltip:e}){return(0,l.xZ)((()=>{const{pointer:s,muted:r,canSetVolume:d}=(0,i.nV)();if("coarse"===s()&&!r())return null;if(!d())return T({tooltip:e});const u=(0,n.O)(void 0),p=(0,o._T)(u);return a.qy`
  ...
  `}))}function Ct(){return(0,l.xZ)((()=>{const{textTracks:t}=(0,i.$c)(),{title:e,started:s}=(0,i.nV)(),o=(0,n.O)(null);return(0,r.q)(t,"chapters",o.set),!o()||!s()&&e()?a.qy`<media-title class="vds-chapter-title"></media-title>`:qt()}))}function qt(){return a.qy`<media-chapter-title class="vds-chapter-title"></media-chapter-title>`}class St extends l.UT{async loadIcons(){const t=(await s.e(71).then(s.bind(s,6071))).icons,e={};for(const s of Object.keys(t))e[s]=(0,l.In)({name:s,paths:t[s]});return e}}var Zt=s(2537);s(580);let Tt=class extends y{static props={...super.props,when:({viewType:t})=>"audio"===t,smallWhen:({width:t})=>t<576}};function Mt(){const t="top end";return[L({tooltip:"top",placement:t,portal:!0}),At({tooltip:"top end",placement:t,portal:!0})]}class It extends((0,n.xr)(Zt.W,Tt)){static tagName="media-audio-layout";static attrs={smallWhen:{converter:t=>"never"!==t&&!!t}};#t;#i=(0,n.O)(!1);onSetup(){this.forwardKeepAlive=!1,this.#t=(0,i.$c)(),this.classList.add("vds-audio-layout"),this.#o()}onConnect(){x("audio",(()=>this.isMatch)),this.#a()}render(){return(0,l.xZ)(this.#l.bind(this))}#l(){return this.isMatch?[_(),N(),a.qy`
      ...
      `}return(0,n.QZ)((()=>{m()&&document.activeElement===document.body&&s.player.el?.focus({preventScroll:!0})})),(0,o.wY)(t,(function(){const s=t(),i=!!s&&!m()&&s.clientWidth<s.children[0].clientWidth;s&&(0,n.p1)(s,"vds-marquee",i),e.set(i)})),r()?a.qy`
        ...
        `:B()})),wt(),(0,l.xZ)((()=>{const{live:t,duration:e}=(0,i.nV)();return t()?E():e()?a.qy`<media-time class="vds-time" type="current" toggle remainder></media-time>`:null})),_t({orientation:"vertical",tooltip:"top"}),M({tooltip:"top"}),P(),q({tooltip:"top"}),Mt()]}
        </media-controls-group>
      </media-controls>
    `]:null}#a(){const{menuPortal:t}=g();(0,n.QZ)((()=>{if(!this.isMatch)return;const e=H(this,this.menuContainer,"vds-audio-layout",(()=>this.isSmallLayout)),s=e?[this,e]:[this];return(this.$props.customIcons()?new l.kj(s):new St(s)).connect(),t.set(e),()=>{e.remove(),t.set(null)}}))}#o(){const{pointer:t}=this.#t.$state;(0,n.QZ)((()=>{"coarse"===t()&&(0,n.QZ)(this.#r.bind(this))}))}#r(){this.#i()?((0,n.k6)(this,"pointerdown",(t=>t.stopPropagation())),(0,n.k6)(window,"pointerdown",this.#d.bind(this))):(0,n.k6)(this,"pointerdown",this.#c.bind(this),{capture:!0})}#c(t){const{target:e}=t;(0,o.sb)(e)&&e.closest(".vds-time-slider")&&(t.stopImmediatePropagation(),this.setAttribute("data-scrubbing",""),this.#i.set(!0))}#d(){this.#i.set(!1),this.removeAttribute("data-scrubbing")}}var Wt=s(7727);const Ot=(0,p.u$)(class extends p.WL{constructor(){super(...arguments),this.key=a.s6}render(t,e){return this.key=t,e}update(t,[e,s]){return e!==this.key&&((0,Wt.mY)(t),this.key=e),s}});class Et extends y{static props={...super.props,when:({viewType:t})=>"video"===t,smallWhen:({width:t,height:e})=>t<576||e<380}}function Pt(){return(0,l.xZ)((()=>{const t=(0,i.$c)(),{noKeyboardAnimations:e,userPrefersKeyboardAnimations:s}=g();if((0,n.EW)((()=>e()||!s()))())return null;const r=(0,n.O)(!1),{lastKeyboardAction:d}=t.$state;(0,n.QZ)((()=>{r.set(!!d());const t=setTimeout((()=>r.set(!1)),500);return()=>{r.set(!1),window.clearTimeout(t)}}));const c=(0,n.EW)((()=>{const t=d()?.action;return t&&r()?(0,n.BW)(t):null})),u=(0,n.EW)((()=>"vds-kb-action"+(r()?"":" hidden"))),p=(0,n.EW)(Nt),m=(0,n.EW)((()=>{const t=function(){const{$state:t}=(0,i.$c)(),e=t.lastKeyboardAction()?.action;switch(e){case"togglePaused":return t.paused()?"kb-pause-icon":"kb-play-icon";case"toggleMuted":return t.muted()||0===t.volume()?"kb-mute-icon":t.volume()>=.5?"kb-volume-up-icon":"kb-volume-down-icon";case"toggleFullscreen":return`kb-fs-${t.fullscreen()?"enter":"exit"}-icon`;case"togglePictureInPicture":return`kb-pip-${t.pictureInPicture()?"enter":"exit"}-icon`;case"toggleCaptions":return t.hasCaptions()?`kb-cc-${t.textTrack()?"on":"off"}-icon`:null;case"volumeUp":return"kb-volume-up-icon";case"volumeDown":return"kb-volume-down-icon";case"seekForward":return"kb-seek-forward-icon";case"seekBackward":return"kb-seek-backward-icon";default:return null}}();return t?(0,o.TL)(t):null}));return a.qy`
  ...
  `}function Ht(){const{menuGroup:t,smallWhen:e}=g(),s=()=>"top"===t()||e()?"bottom":"top",i=(0,n.EW)((()=>`${s()} ${"top"===t()?"end":"center"}`)),o=(0,n.EW)((()=>`${s()} end`));return[L({tooltip:i,placement:o,portal:!0}),At({tooltip:i,placement:o,portal:!0})]}function Lt(){return(0,l.xZ)((()=>{const{noGestures:t}=g();return t()?null:a.qy`
    ...
    `}))}class Gt extends((0,n.xr)(Zt.W,Et)){static tagName="media-video-layout";static attrs={smallWhen:{converter:t=>"never"!==t&&!!t}};#t;onSetup(){this.forwardKeepAlive=!1,this.#t=(0,i.$c)(),this.classList.add("vds-video-layout")}onConnect(){x("video",(()=>this.isMatch)),this.#a()}render(){return(0,l.xZ)(this.#l.bind(this))}#a(){const{menuPortal:t}=g();(0,n.QZ)((()=>{if(!this.isMatch)return;const e=H(this,this.menuContainer,"vds-video-layout",(()=>this.isSmallLayout)),s=e?[this,e]:[this];return(this.$props.customIcons()?new l.kj(s):new St(s)).connect(),t.set(e),()=>{e.remove(),t.set(null)}}))}#l(){const{load:t}=this.#t.$props,{canLoad:e,streamType:s,nativeControls:n}=this.#t.$state;return!n()&&this.isMatch?"play"!==t()||e()?"unknown"===s()?Vt():this.isSmallLayout?[_(),Lt(),Vt(),N(),Pt(),a.qy`<div class="vds-scrim"></div>`,a.qy`
      <media-controls class="vds-controls">
        <media-controls-group class="vds-controls-group">
          ${[q({tooltip:"top start"}),S({tooltip:"bottom start"}),B(),M({tooltip:"bottom"}),P(),Ht(),_t({orientation:"vertical",tooltip:"bottom end"})]}
        </media-controls-group>
  ...
  `,B(),a.qy`<media-controls-group class="vds-controls-group"></media-controls-group>`,B(),a.qy`
          ...
          `,a.qy`
            <media-controls-group class="vds-controls-group">
              ${[Z({tooltip:"top start"}),_t({orientation:"horizontal",tooltip:"top"}),kt(),Ct(),M({tooltip:"top"}),(0,l.xZ)((()=>{const{menuGroup:t}=g();return"bottom"===t()?Ht():null})),q({tooltip:"top"}),S({tooltip:"top"}),P(),I(),W({tooltip:"top end"})]}
            </media-controls-group>
          `]}
      </media-controls>
    `]:a.qy`
  ...
  `:null}}(0,n.Xq)(It),(0,n.Xq)(Gt)},8145:(t,e,s)=>{s.d(e,{In:()=>v,UT:()=>g,kj:()=>h,xZ:()=>c});var n=s(4487),i=s(4245),o=s(1822),a=s(580),l=s(6214),r=s(9469);class d extends l.Kq{#u=null;#p=!1;#m=null;constructor(t){super(t),this.#p=t.type===l.OA.ATTRIBUTE||t.type===l.OA.BOOLEAN_ATTRIBUTE}render(t){return t!==this.#u&&(this.disconnected(),this.#u=t,this.isConnected&&this.#h()),this.#u?this.#v((0,n.se)(this.#u)):i.s6}reconnected(){this.#h()}disconnected(){this.#m?.(),this.#m=null}#h(){this.#u&&(this.#m=(0,n.QZ)(this.#$.bind(this)))}#v(t){return this.#p?(0,o.J)(t):t}#g(t){this.setValue(this.#v(t))}#$(){this.#g(this.#u?.())}}function c(t){return(0,l.u$)(d)((0,n.EW)(t))}class u{#b;#y;elements=new Set;constructor(t,e){this.#b=t,this.#y=e}connect(){this.#f();const t=new MutationObserver(this.#x);for(const e of this.#b)t.observe(e,{childList:!0,subtree:!0});(0,n.zp)((()=>t.disconnect())),(0,n.zp)(this.disconnect.bind(this))}disconnect(){this.elements.clear()}assign(t,e){(0,n.vA)(t)?(e.textContent="",e.append(t)):((0,i.XX)(null,e),(0,i.XX)(t,e)),e.style.display||(e.style.display="contents");const s=e.firstElementChild;if(!s)return;const o=e.getAttribute("data-class");o&&s.classList.add(...o.split(" "))}#x=(0,n.s_)(this.#f.bind(this));#f(t){if(t&&!t.some((t=>t.addedNodes.length)))return;let e=!1,s=this.#b.flatMap((t=>[...t.querySelectorAll("slot")]));for(const t of s)t.hasAttribute("name")&&!this.elements.has(t)&&(this.elements.add(t),e=!0);e&&this.#y(this.elements)}}let p=0,m="data-slot-id";class h{#b;slots;constructor(t){this.#b=t,this.slots=new u(t,this.#f.bind(this))}connect(){this.slots.connect(),this.#f();const t=new MutationObserver(this.#x);for(const e of this.#b)t.observe(e,{childList:!0});(0,n.zp)((()=>t.disconnect()))}#x=(0,n.s_)(this.#f.bind(this));#f(){for(const t of this.#b)for(const e of t.children){if(1!==e.nodeType)continue;const t=e.getAttribute("slot");if(!t)continue;e.style.display="none";let s=e.getAttribute(m);s||e.setAttribute(m,s=++p+"");for(const n of this.slots.elements){if(n.getAttribute("name")!==t||n.getAttribute(m)===s)continue;const i=document.importNode(e,!0);t.includes("-icon")&&i.classList.add("vds-icon"),i.style.display="",i.removeAttribute("slot"),this.slots.assign(i,n),n.setAttribute(m,s)}}}}function v({name:t,class:e,state:s,paths:l,viewBox:r="0 0 32 32"}){return i.qy`<svg
    class="${"vds-icon"+(e?` ${e}`:"")}"
    viewBox="${r}"
    fill="none"
    aria-hidden="true"
  ...
  </svg>`}class ${#A={};#_=!1;slots;constructor(t){this.slots=new u(t,this.#w.bind(this))}connect(){this.slots.connect()}load(){this.loadIcons().then((t=>{this.#A=t,this.#_=!0,this.#w()}))}*#k(){for(const t of Object.keys(this.#A)){const e=`${t}-icon`;for(const s of this.slots.elements)s.name===e&&(yield{icon:this.#A[t],slot:s})}}#w(){if(this.#_)for(const{icon:t,slot:e}of this.#k())this.slots.assign(t,e)}}class g extends ${connect(){super.connect();const{player:t}=(0,r.$c)();if(!t.el)return;let e,s=new IntersectionObserver((t=>{t[0]?.isIntersecting&&(e?.(),e=void 0,this.load())}));s.observe(t.el),e=(0,n.zp)((()=>s.disconnect()))}}}}]);